...
let linearRegressionWithStandardGradientDescent = LinearRegression.fitWithGradientDescent Optimization.Regularization.Without Optimization.GradientDescent.Standard
let fit = linearRegressionWithStandardGradientDescent trainingX trainingY 0.01 1500
