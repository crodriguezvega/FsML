...
let linearRegressionWithStochasticGradientDescent = LinearRegression.fitWithGradientDescent Optimization.Regularization.Without Optimization.GradientDescent.Stochastic
let fit = linearRegressionWithStochasticGradientDescent trainingX trainingY 0.01 1500
